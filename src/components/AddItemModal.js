        ...
        <div className={styles.overlay}>
            <div className={styles.modal} style={{ position: 'relative', overflow: 'visible' }}>
                <div style={{ position: 'absolute', top: '-60px', left: '50%', transform: 'translateX(-50%)', zIndex: 10 }}>
                    <img src={rubyImages['05']} alt="" style={{ width: '100px', height: 'auto', mixBlendMode: 'multiply' }} />
                </div>
                {/* Side decorations */}
                <img src={rubyImages['11']} alt="" style={{ position: 'absolute', bottom: '-20px', left: '-30px', width: '60px', height: 'auto', transform: 'rotate(-10deg)', pointerEvents: 'none', mixBlendMode: 'multiply' }} />
                <img src={rubyImages['12']} alt="" style={{ position: 'absolute', top: '-20px', right: '-20px', width: '50px', height: 'auto', transform: 'rotate(15deg)', pointerEvents: 'none', mixBlendMode: 'multiply' }} />
